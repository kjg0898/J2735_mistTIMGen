...
/**
 * Define the ASN1 Type MapData_addGrpC from ASN1 Module AddGrpC.
 * @see Sequence
 */

public class MapData_addGrpC extends Sequence {
    ...
    {
	mComponents[0] = new SignalHeadLocationList();
    }
	...
	switch (index) {
	    case 0:
		return new SignalHeadLocationList();
	    default:
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MapData_addGrpC object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MapData_addGrpC object.
     */
