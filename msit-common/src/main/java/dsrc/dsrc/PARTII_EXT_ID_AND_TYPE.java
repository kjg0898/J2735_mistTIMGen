...
/**
 * Define the ASN1 Type PARTII_EXT_ID_AND_TYPE from ASN1 Module DSRC.
 * @see InfoObject
 */

public class PARTII_EXT_ID_AND_TYPE extends InfoObject {
    ...
    {
	return (PartII_Id)mComponents[0];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PARTII_EXT_ID_AND_TYPE object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PARTII_EXT_ID_AND_TYPE object.
     */
