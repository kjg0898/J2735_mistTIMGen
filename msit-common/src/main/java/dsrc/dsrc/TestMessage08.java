...
/**
 * Define the ASN1 Type TestMessage08 from ASN1 Module DSRC.
 * @see Sequence
 */

public class TestMessage08 extends Sequence {
     ...
     */
    public TestMessage08(Header header, Regional regional)
    {
	setHeader(header);
		...
		new SequenceFieldInfo[] {
			...
			new TypeInfoRef (
				...
				new Intersection (
				    ...
				    new TableConstraint (
					dsrc.region.REGION.reg_TestMessage08,
					0
				    )
				),
				new Bounds (
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TestMessage08 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TestMessage08 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for TestMessage08
