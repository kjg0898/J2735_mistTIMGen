...
/**
 * Define the ASN1 Type VehicleClassification from ASN1 Module DSRC.
 * @see Sequence
 */
...
public class VehicleClassification extends Sequence {
	...
	mComponents[1] = BasicVehicleRole.basicVehicle;
	mComponents[2] = new Iso3833VehicleType();
	mComponents[3] = VehicleType.none;
	mComponents[4] = dsrc.itis.VehicleGroupAffected.all_vehicles;
	mComponents[5] = dsrc.itis.IncidentResponseEquipment.ground_fire_suppression;
	mComponents[6] = dsrc.itis.ResponderGroupAffected.emergency_vehicle_units;
	mComponents[7] = new FuelType();
    ...
    {
	return (BasicVehicleRole)mComponents[1];
    }
    ...
    {
	return (Iso3833VehicleType)mComponents[2];
    }
    
    public void setIso3883(Iso3833VehicleType iso3883)
    {
	mComponents[2] = iso3883;
    }
    ...
    {
	return (VehicleType)mComponents[3];
    }
    
    public void setHpmsType(VehicleType hpmsType)
    {
	mComponents[3] = hpmsType;
    }
    ...
    {
	return (dsrc.itis.VehicleGroupAffected)mComponents[4];
    }
    ...
    {
	return (dsrc.itis.IncidentResponseEquipment)mComponents[5];
    }
    
    public void setResponseEquip(dsrc.itis.IncidentResponseEquipment responseEquip)
    {
	mComponents[5] = responseEquip;
    }
    ...
    {
	return (dsrc.itis.ResponderGroupAffected)mComponents[6];
    }
    
    public void setResponderType(dsrc.itis.ResponderGroupAffected responderType)
    {
	mComponents[6] = responderType;
    }
    ...
    {
	return (FuelType)mComponents[7];
    }
    
    public void setFuelType(FuelType fuelType)
    {
	mComponents[7] = fuelType;
    }
	...
	public static class Sequence_ extends Sequence {
		...
		new QName (
		    "dsrc.dsrc",
		    "VehicleClassification$Regional$Sequence_"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new FieldsDict (
			...
			new SequenceFieldInfo (
				...
				new IntegerInfo (
					...
					new TableConstraint (
					    dsrc.region.REGION.reg_VehicleClassification,
					    0
					)
				    ),
				    new Bounds (
	...
	private static final ContainerInfo c_typeinfo = new ContainerInfo (
	    ...
	    new QName (
		"dsrc.dsrc",
		"VehicleClassification$Regional"
	    ),
	    new QName (
		"builtin",
		"SEQUENCE OF"
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' VehicleClassification object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' VehicleClassification object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
