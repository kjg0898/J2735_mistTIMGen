...
/**
 * Define the ASN1 Type NumberOfParticipantsInCluster from ASN1 Module DSRC.
 * @see Enumerated
 */
...
public final class NumberOfParticipantsInCluster extends Enumerated {
    ...
    protected NumberOfParticipantsInCluster(long value)
    {
	super(value);
    }
    ...
    private final static NumberOfParticipantsInCluster cNamedNumbers[] = {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NumberOfParticipantsInCluster object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NumberOfParticipantsInCluster object.
     */
