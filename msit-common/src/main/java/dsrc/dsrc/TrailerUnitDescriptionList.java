...
/**
 * Define the ASN1 Type TrailerUnitDescriptionList from ASN1 Module DSRC.
 * @see SequenceOf
 */
...
public class TrailerUnitDescriptionList extends SequenceOf<TrailerUnitDescription> {
    ...
    {
	return (AbstractData)new TrailerUnitDescription();
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TrailerUnitDescriptionList object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TrailerUnitDescriptionList object.
     */
