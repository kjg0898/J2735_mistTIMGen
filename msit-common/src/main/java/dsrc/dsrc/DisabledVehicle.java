...
/**
 * Define the ASN1 Type DisabledVehicle from ASN1 Module DSRC.
 * @see Sequence
 */
...
public class DisabledVehicle extends Sequence {
     ...
     */
    public DisabledVehicle(dsrc.itis.ITIScodes statusDetails, 
	...
	mComponents[1] = dsrc.itis.GenericLocations.on_bridges;
    }
    ...
    public dsrc.itis.ITIScodes getStatusDetails()
    {
	return (dsrc.itis.ITIScodes)mComponents[0];
    }
    
    public void setStatusDetails(dsrc.itis.ITIScodes statusDetails)
    {
	mComponents[0] = statusDetails;
    }
    ...
    {
	return (dsrc.itis.GenericLocations)mComponents[1];
    }
    
    public void setLocationDetails(dsrc.itis.GenericLocations locationDetails)
    {
	mComponents[1] = locationDetails;
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DisabledVehicle object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DisabledVehicle object.
     */
