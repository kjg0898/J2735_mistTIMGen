...
public final class RTCM_Revision extends Enumerated {
    ...
    protected RTCM_Revision(long value)
    {
	super(value);
    }
    ...
    private final static RTCM_Revision cNamedNumbers[] = {
	new RTCM_Revision(), 
	new RTCM_Revision(1), 
	new RTCM_Revision(2), 
	new RTCM_Revision(3)
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RTCM_Revision object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RTCM_Revision object.
     */
