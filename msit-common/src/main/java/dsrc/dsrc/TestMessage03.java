...
/**
 * Define the ASN1 Type TestMessage03 from ASN1 Module DSRC.
 * @see Sequence
 */

public class TestMessage03 extends Sequence {
		...
		new SequenceFieldInfo[] {
			...
			new TypeInfoRef (
				...
				new Intersection (
				    ...
				    new TableConstraint (
					dsrc.region.REGION.reg_TestMessage03,
					0
				    )
				),
				new Bounds (
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TestMessage03 object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TestMessage03 object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
