...
public final class NMEA_Revision extends Enumerated {
    ...
    protected NMEA_Revision(long value)
    {
	super(value);
    }
    ...
    private final static NMEA_Revision cNamedNumbers[] = {
	new NMEA_Revision(), 
	new NMEA_Revision(1), 
	new NMEA_Revision(2), 
	new NMEA_Revision(3), 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NMEA_Revision object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NMEA_Revision object.
     */
