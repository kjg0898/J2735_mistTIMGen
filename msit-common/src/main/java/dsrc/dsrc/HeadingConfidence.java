...
public final class HeadingConfidence extends Enumerated {
    ...
    protected HeadingConfidence(long value)
    {
	super(value);
    }
    ...
    private final static HeadingConfidence cNamedNumbers[] = {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' HeadingConfidence object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' HeadingConfidence object.
     */
