...
/**
 * Define the ASN1 Type RestrictionUserType from ASN1 Module DSRC.
 * @see Choice
 */

public class RestrictionUserType extends Choice {
    ...
    public static final  int  basicType_chosen = 1;
    public static final  int  regional_chosen = 2;
    
    // Methods for field "basicType"
    public static RestrictionUserType createRestrictionUserTypeWithBasicType(RestrictionAppliesTo basicType)
    {
	RestrictionUserType __object = new RestrictionUserType();

	__object.setBasicType(basicType);
	return __object;
    }
    
    public boolean hasBasicType()
    {
	return getChosenFlag() == basicType_chosen;
    }
    
    public RestrictionAppliesTo getBasicType()
    {
	if (hasBasicType())
	    return (RestrictionAppliesTo)mChosenValue;
	else
	    return null;
    }
    ...
    {
	setChosenValue(basicType);
	setChosenFlag(basicType_chosen);
    }
    
    
    // Methods for field "regional"
    public static RestrictionUserType createRestrictionUserTypeWithRegional(Regional regional)
    {
	RestrictionUserType __object = new RestrictionUserType();
	...
	public static class Sequence_ extends Sequence {
		...
		new QName (
		    "dsrc.dsrc",
		    "RestrictionUserType$Regional$Sequence_"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new FieldsDict (
			...
			new SequenceFieldInfo (
				...
				new IntegerInfo (
					...
					new TableConstraint (
					    dsrc.region.REGION.reg_RestrictionUserType,
					    0
					)
				    ),
				    new Bounds (
    ...
    {
	switch (chosen) {
	    case basicType_chosen:
		return RestrictionAppliesTo.none;
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RestrictionUserType object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RestrictionUserType object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for RestrictionUserType
