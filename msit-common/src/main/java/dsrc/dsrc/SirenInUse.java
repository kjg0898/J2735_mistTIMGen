...
public final class SirenInUse extends Enumerated {
    ...
    protected SirenInUse(long value)
    {
	super(value);
    }
    ...
    private final static SirenInUse cNamedNumbers[] = {
	new SirenInUse(), 
	new SirenInUse(1), 
	new SirenInUse(2), 
	new SirenInUse(3)
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SirenInUse object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SirenInUse object.
     */
