...
/**
 * Define the ASN1 Type IntersectionGeometry from ASN1 Module DSRC.
 * @see Sequence
 */
...
public class IntersectionGeometry extends Sequence {
	...
	mComponents[6] = new LaneList();
	mComponents[7] = new PreemptPriorityList();
	...
	switch (index) {
		...
		return new LaneList();
	    case 7:
		return new PreemptPriorityList();
	    case 8:
		return new Regional();
	    default:
    ...
    {
	return (LaneList)mComponents[6];
    }
    
    public void setLaneSet(LaneList laneSet)
    {
	mComponents[6] = laneSet;
    }
	...
	public static class Sequence_ extends Sequence {
		...
		new QName (
		    "dsrc.dsrc",
		    "IntersectionGeometry$Regional$Sequence_"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new FieldsDict (
			...
			new SequenceFieldInfo (
				...
				new IntegerInfo (
					...
					new TableConstraint (
					    dsrc.region.REGION.reg_IntersectionGeometry,
					    0
					)
				    ),
				    new Bounds (
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' IntersectionGeometry object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' IntersectionGeometry object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
