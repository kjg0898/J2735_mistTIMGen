...
/**
 * Define the ASN1 Type SpeedProfileMeasurementList from ASN1 Module DSRC.
 * @see SequenceOf
 */
...
public class SpeedProfileMeasurementList extends SequenceOf<SpeedProfileMeasurement> {
    ...
    {
	return (AbstractData)new SpeedProfileMeasurement();
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SpeedProfileMeasurementList object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SpeedProfileMeasurementList object.
     */
