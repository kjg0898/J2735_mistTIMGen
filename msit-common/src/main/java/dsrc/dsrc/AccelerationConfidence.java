...
public final class AccelerationConfidence extends Enumerated {
    ...
    protected AccelerationConfidence(long value)
    {
	super(value);
    }
    ...
    private final static AccelerationConfidence cNamedNumbers[] = {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' AccelerationConfidence object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' AccelerationConfidence object.
     */
