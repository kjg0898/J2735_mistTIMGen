...
/**
 * Define the ASN1 Type LaneAttributes_TrackedVehicle from ASN1 Module DSRC.
 * @see BitString
 */
...
public class LaneAttributes_TrackedVehicle extends BitString {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' LaneAttributes_TrackedVehicle object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' LaneAttributes_TrackedVehicle object.
     */
