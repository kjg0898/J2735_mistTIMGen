...
/**
 * Define the ASN1 Type SignalRequestPackage from ASN1 Module DSRC.
 * @see Sequence
 */

public class SignalRequestPackage extends Sequence {
     ...
     */
    public SignalRequestPackage(SignalRequest request, MinuteOfTheYear minute, 
		    DSecond second, DSecond duration, Regional regional)
    {
	setRequest(request);
	setMinute(minute);
	setSecond(second);
     ...
     */
    public SignalRequestPackage(SignalRequest request)
    {
	setRequest(request);
    }
    ...
    {
	return (SignalRequest)mComponents[0];
    }
    
    public void setRequest(SignalRequest request)
    {
	mComponents[0] = request;
    }
    ...
    {
	return (DSecond)mComponents[3];
    }
    
    public void setDuration(DSecond duration)
    {
	mComponents[3] = duration;
    }
	...
	public static class Sequence_ extends Sequence {
		...
		new QName (
		    "dsrc.dsrc",
		    "SignalRequestPackage$Regional$Sequence_"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new FieldsDict (
			...
			new SequenceFieldInfo (
				...
				new IntegerInfo (
					...
					new TableConstraint (
					    dsrc.region.REGION.reg_SignalRequestPackage,
					    0
					)
				    ),
				    new Bounds (
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SignalRequestPackage object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SignalRequestPackage object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SignalRequestPackage
