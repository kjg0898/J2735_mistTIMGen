...
/**
 * Define the ASN1 Type SpeedLimitType from ASN1 Module DSRC.
 * @see Enumerated
 */
...
public final class SpeedLimitType extends Enumerated {
    ...
    protected SpeedLimitType(long value)
    {
	super(value);
    }
    ...
    private final static SpeedLimitType cNamedNumbers[] = {
	new SpeedLimitType(), 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SpeedLimitType object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SpeedLimitType object.
     */
