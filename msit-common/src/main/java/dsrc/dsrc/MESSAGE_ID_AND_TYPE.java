...
/**
 * Define the ASN1 Type MESSAGE_ID_AND_TYPE from ASN1 Module DSRC.
 * @see InfoObject
 */

public class MESSAGE_ID_AND_TYPE extends InfoObject {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' MESSAGE_ID_AND_TYPE object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' MESSAGE_ID_AND_TYPE object.
     */
