...
/**
 * Define the ASN1 Type LaneSharing from ASN1 Module DSRC.
 * @see BitString
 */
...
public class LaneSharing extends BitString {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' LaneSharing object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' LaneSharing object.
     */
