...
/**
 * Define the ASN1 Type NMEAcorrections from ASN1 Module DSRC.
 * @see Sequence
 */

public class NMEAcorrections extends Sequence {
	...
	mComponents[1] = NMEA_Revision.unknown;
	mComponents[2] = new NMEA_MsgType();
	mComponents[3] = new ObjectCount();
	mComponents[4] = new NMEA_Payload();
	...
	switch (index) {
	    ...
	    case 1:
		return NMEA_Revision.unknown;
	    case 2:
		return new NMEA_MsgType();
	    case 3:
		return new ObjectCount();
	    case 4:
		return new NMEA_Payload();
	    case 5:
		return new Regional();
	    default:
    ...
    {
	return (NMEA_Revision)mComponents[1];
    }
    ...
    {
	return (NMEA_MsgType)mComponents[2];
    }
    ...
    {
	return (ObjectCount)mComponents[3];
    }
    
    public void setWdCount(ObjectCount wdCount)
    {
	mComponents[3] = wdCount;
    }
    ...
    {
	return (NMEA_Payload)mComponents[4];
    }
    
    public void setPayload(NMEA_Payload payload)
    {
	mComponents[4] = payload;
    }
	...
	public static class Sequence_ extends Sequence {
		...
		new QName (
		    "dsrc.dsrc",
		    "NMEAcorrections$Regional$Sequence_"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new FieldsDict (
			...
			new SequenceFieldInfo (
				...
				new IntegerInfo (
					...
					new TableConstraint (
					    dsrc.region.REGION.reg_NMEAcorrections,
					    0
					)
				    ),
				    new Bounds (
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NMEAcorrections object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NMEAcorrections object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
