...
/**
 * Define the ASN1 Type LaneAttributes_Barrier from ASN1 Module DSRC.
 * @see BitString
 */
...
public class LaneAttributes_Barrier extends BitString {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' LaneAttributes_Barrier object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' LaneAttributes_Barrier object.
     */
