...
public final class TravelerInfoType extends Enumerated {
    ...
    protected TravelerInfoType(long value)
    {
	super(value);
    }
    ...
    private final static TravelerInfoType cNamedNumbers[] = {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' TravelerInfoType object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' TravelerInfoType object.
     */
