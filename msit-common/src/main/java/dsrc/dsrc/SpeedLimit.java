...
public class SpeedLimit extends SequenceOf<SpeedLimit.Sequence_> {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SpeedLimit object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SpeedLimit object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
