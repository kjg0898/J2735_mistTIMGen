...
/**
 * Define the ASN1 Type PersonalDeviceUserType from ASN1 Module DSRC.
 * @see Enumerated
 */
...
public final class PersonalDeviceUserType extends Enumerated {
    ...
    protected PersonalDeviceUserType(long value)
    {
	super(value);
    }
    ...
    private final static PersonalDeviceUserType cNamedNumbers[] = {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' PersonalDeviceUserType object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' PersonalDeviceUserType object.
     */
