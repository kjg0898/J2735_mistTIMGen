...
public class GenericSignage extends SequenceOf<GenericSignage.Sequence_> {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' GenericSignage object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' GenericSignage object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
