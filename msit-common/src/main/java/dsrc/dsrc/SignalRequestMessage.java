...
/**
 * Define the ASN1 Type SignalRequestMessage from ASN1 Module DSRC.
 * @see Sequence
 */

public class SignalRequestMessage extends Sequence {
     ...
     */
    public SignalRequestMessage(MinuteOfTheYear timeStamp, DSecond second, 
		    MsgCount sequenceNumber, SignalRequestList requests, 
		    RequestorDescription requestor, Regional regional)
    {
     ...
     */
    public SignalRequestMessage(DSecond second, 
	...
	mComponents[3] = new SignalRequestList();
	mComponents[4] = new RequestorDescription();
    ...
    {
	return (SignalRequestList)mComponents[3];
    }
	...
	public static class Sequence_ extends Sequence {
		...
		new QName (
		    "dsrc.dsrc",
		    "SignalRequestMessage$Regional$Sequence_"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new FieldsDict (
			...
			new SequenceFieldInfo (
				...
				new IntegerInfo (
					...
					new TableConstraint (
					    dsrc.region.REGION.reg_SignalRequestMessage,
					    0
					)
				    ),
				    new Bounds (
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SignalRequestMessage object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SignalRequestMessage object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for SignalRequestMessage
