...
/**
 * Define the ASN1 Type AdvisorySpeedType from ASN1 Module DSRC.
 * @see Enumerated
 */
...
public final class AdvisorySpeedType extends Enumerated {
    ...
    protected AdvisorySpeedType(long value)
    {
	super(value);
    }
    ...
    private final static AdvisorySpeedType cNamedNumbers[] = {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' AdvisorySpeedType object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' AdvisorySpeedType object.
     */
