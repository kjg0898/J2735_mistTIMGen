...
/**
 * Define the ASN1 Type NodeAttributeSetXY from ASN1 Module DSRC.
 * @see Sequence
 */

public class NodeAttributeSetXY extends Sequence {
     ...
     */
    public NodeAttributeSetXY(NodeAttributeXYList localNode, 
    ...
    {
	mComponents[0] = new NodeAttributeXYList();
	mComponents[1] = new SegmentAttributeXYList();
	mComponents[2] = new SegmentAttributeXYList();
    ...
    {
	return (NodeAttributeXYList)mComponents[0];
    }
    ...
    {
	return (SegmentAttributeXYList)mComponents[1];
    }
    ...
    {
	return (SegmentAttributeXYList)mComponents[2];
    }
	...
	public static class Sequence_ extends Sequence {
		...
		new QName (
		    "dsrc.dsrc",
		    "NodeAttributeSetXY$Regional$Sequence_"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new FieldsDict (
			...
			new SequenceFieldInfo (
				...
				new IntegerInfo (
					...
					new TableConstraint (
					    dsrc.region.REGION.reg_NodeAttributeSetXY,
					    0
					)
				    ),
				    new Bounds (
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' NodeAttributeSetXY object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' NodeAttributeSetXY object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
...
} // End class definition for NodeAttributeSetXY
