...
/**
 * Define the ASN1 Type SignalStatus from ASN1 Module DSRC.
 * @see Sequence
 */
...
public class SignalStatus extends Sequence {
	...
	mComponents[2] = new SignalStatusPackageList();
	...
	switch (index) {
	    ...
	    case 2:
		return new SignalStatusPackageList();
	    case 3:
		return new Regional();
	    default:
    ...
    {
	return (SignalStatusPackageList)mComponents[2];
    }
    
    public void setSigStatus(SignalStatusPackageList sigStatus)
    {
	mComponents[2] = sigStatus;
    }
	...
	public static class Sequence_ extends Sequence {
		...
		new QName (
		    "dsrc.dsrc",
		    "SignalStatus$Regional$Sequence_"
		),
		new QName (
		    "builtin",
		    "SEQUENCE"
		...
		new FieldsDict (
			...
			new SequenceFieldInfo (
				...
				new IntegerInfo (
					...
					new TableConstraint (
					    dsrc.region.REGION.reg_SignalStatus,
					    0
					)
				    ),
				    new Bounds (
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' SignalStatus object.
     */
    public TypeInfo getTypeInfo()
    {
	return c_typeinfo;
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' SignalStatus object.
     */
    public static TypeInfo getStaticTypeInfo()
    {
	return c_typeinfo;
