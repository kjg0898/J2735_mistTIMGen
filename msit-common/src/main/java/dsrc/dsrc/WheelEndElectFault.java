...
public final class WheelEndElectFault extends Enumerated {
    ...
    protected WheelEndElectFault(long value)
    {
	super(value);
    }
    ...
    private final static WheelEndElectFault cNamedNumbers[] = {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' WheelEndElectFault object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' WheelEndElectFault object.
     */
