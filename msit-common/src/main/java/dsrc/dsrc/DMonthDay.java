...
public class DMonthDay extends Sequence {
    ...
    {
	mComponents[0] = new DMonth();
	mComponents[1] = new DDay();
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' DMonthDay object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' DMonthDay object.
     */
