...
/**
 * Define the ASN1 Type Node_LL_24B from ASN1 Module DSRC.
 * @see Sequence
 */
...
public class Node_LL_24B extends Sequence {
    ...
    {
	mComponents[0] = new OffsetLL_B12();
	mComponents[1] = new OffsetLL_B12();
    }
    ...
    {
	return (OffsetLL_B12)mComponents[0];
    }
    ...
    {
	return (OffsetLL_B12)mComponents[1];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Node_LL_24B object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Node_LL_24B object.
     */
