...
/**
 * Define the ASN1 Type LaneAttributes_Bike from ASN1 Module DSRC.
 * @see BitString
 */
...
public class LaneAttributes_Bike extends BitString {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' LaneAttributes_Bike object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' LaneAttributes_Bike object.
     */
