...
/**
 * Define the ASN1 Type RequestSubRole from ASN1 Module DSRC.
 * @see Enumerated
 */
...
public final class RequestSubRole extends Enumerated {
    ...
    protected RequestSubRole(long value)
    {
	super(value);
    }
    ...
    private final static RequestSubRole cNamedNumbers[] = {
	new RequestSubRole(), 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RequestSubRole object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RequestSubRole object.
     */
