...
/**
 * Define the ASN1 Type Node_XY_24b from ASN1 Module DSRC.
 * @see Sequence
 */
...
public class Node_XY_24b extends Sequence {
    ...
    {
	return (Offset_B12)mComponents[1];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' Node_XY_24b object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' Node_XY_24b object.
     */
