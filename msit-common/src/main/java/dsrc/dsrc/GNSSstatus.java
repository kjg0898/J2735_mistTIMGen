...
/**
 * Define the ASN1 Type GNSSstatus from ASN1 Module DSRC.
 * @see BitString
 */
...
public class GNSSstatus extends BitString {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' GNSSstatus object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' GNSSstatus object.
     */
