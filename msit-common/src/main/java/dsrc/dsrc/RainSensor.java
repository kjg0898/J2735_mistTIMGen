...
public final class RainSensor extends Enumerated {
    ...
    protected RainSensor(long value)
    {
	super(value);
    }
    ...
    private final static RainSensor cNamedNumbers[] = {
	new RainSensor(), 
	new RainSensor(1), 
	new RainSensor(2), 
	new RainSensor(3), 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RainSensor object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RainSensor object.
     */
