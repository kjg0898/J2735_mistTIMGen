...
/**
 * Define the ASN1 Type RoadSegmentReferenceID from ASN1 Module DSRC.
 * @see Sequence
 */
...
public class RoadSegmentReferenceID extends Sequence {
	...
	mComponents[1] = new RoadSegmentID();
    }
    ...
    {
	return (RoadSegmentID)mComponents[1];
    }
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' RoadSegmentReferenceID object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' RoadSegmentReferenceID object.
     */
