...
public final class YawRateConfidence extends Enumerated {
    ...
    protected YawRateConfidence(long value)
    {
	super(value);
    }
    ...
    private final static YawRateConfidence cNamedNumbers[] = {
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' YawRateConfidence object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' YawRateConfidence object.
     */
