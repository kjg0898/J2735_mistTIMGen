...
public final class EssPrecipYesNo extends Enumerated {
    ...
    protected EssPrecipYesNo(long value)
    {
	super(value);
    }
    ...
    private final static EssPrecipYesNo cNamedNumbers[] = {
	new EssPrecipYesNo(), 
    ...
    /**
     * Get the type descriptor (TypeInfo) of 'this' EssPrecipYesNo object.
     */
    ...
    /**
     * Get the static type descriptor (TypeInfo) of 'this' EssPrecipYesNo object.
     */
