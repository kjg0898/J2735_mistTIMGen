 ...
 */
public class SpatLauncher {
    private static final Logger logger = LoggerFactory.getLogger(SpatLauncher.class);

    public static void main(String[] args) {
        Vertx vertx = Vertx.vertx();
        vertx.deployVerticle(new ExecutionSpatModule(), res -> {
            if (res.succeeded()) {
